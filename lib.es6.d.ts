...
interface Array<T> {
  ...
  every<Z>(
    callbackfn: (this: Z, value: T, index: number, array: T[]) => boolean,
    thisArg: Z
  ): boolean;
  /**
      * Determines whether the specified callback function returns true for any element of an array.
  ...
  /**
      ...
      */
  forEach(
    callbackfn: (this: void, value: T, index: number, array: T[]) => void
  ): void;
  forEach(
    callbackfn: (this: void, value: T, index: number, array: T[]) => void,
    thisArg: undefined
  ...
  forEach<Z>(
    callbackfn: (this: Z, value: T, index: number, array: T[]) => void,
    thisArg: Z
  ): void;
  /**
      * Calls a defined callback function on each element of an array, and returns an array that contains the results.
  ...
  map<U>(
    this: [T, T, T, T, T],
    callbackfn: (this: void, value: T, index: number, array: T[]) => U
  ): [U, U, U, U, U];
  map<U>(
    this: [T, T, T, T, T],
    callbackfn: (this: void, value: T, index: number, array: T[]) => U,
  ...
  map<Z, U>(
    this: [T, T, T, T, T],
    callbackfn: (this: Z, value: T, index: number, array: T[]) => U,
    thisArg: Z
  ): [U, U, U, U, U];
  /**
      * Calls a defined callback function on each element of an array, and returns an array that contains the results.
  ...
  filter<Z>(
    callbackfn: (this: Z, value: T, index: number, array: T[]) => any,
    thisArg: Z
  ): T[];
  /**
      * Calls the specified callback function for all the elements in an array. The return value of the callback function is the accumulated result, and is provided as an argument in the next call to the callback function.
...
interface Int8ArrayConstructor {
  ...
  from(
    ...
    mapfn: (this: void, v: number, k: number) => number
  ): Int8Array;
  from(
    arrayLike: ArrayLike<number>,
    mapfn: (this: void, v: number, k: number) => number,
  ...
  from<Z>(
    arrayLike: ArrayLike<number>,
    mapfn: (this: Z, v: number, k: number) => number,
    thisArg: Z
  ): Int8Array;
...
interface Array<T> {
  ...
  find<Z>(
    predicate: (this: Z, value: T, index: number, obj: Array<T>) => boolean,
    thisArg: Z
  ): T | undefined;
...
interface ArrayConstructor {
  ...
  from<T, U>(
    ...
    mapfn: (this: void, v: T, k: number) => U
  ): Array<U>;
  from<T, U>(
    arrayLike: ArrayLike<T>,
    mapfn: (this: void, v: T, k: number) => U,
...
interface AudioBufferSourceNode extends AudioNode {
  ...
  addEventListener<K extends keyof AudioBufferSourceNodeEventMap>(
    type: K,
    listener: (
      this: AudioBufferSourceNode,
      ev: AudioBufferSourceNodeEventMap[K]
    ) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
...
interface AudioContextBase extends EventTarget {
  ...
  resume(): Promise<void>;
  addEventListener<K extends keyof AudioContextEventMap>(
    type: K,
    listener: (this: AudioContext, ev: AudioContextEventMap[K]) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface Document
  ...
  /**
      ...
      */
  getElementsByTagName<K extends keyof ElementListTagNameMap>(
    tagname: K
...
declare var File: {
  prototype: File;
  new (
    parts: (ArrayBuffer | ArrayBufferView | Blob | string)[],
    filename: string,
...
interface FileReader extends EventTarget, MSBaseReader {
  ...
  addEventListener<K extends keyof MSBaseReaderEventMap>(
    type: K,
    listener: (this: FileReader, ev: MSBaseReaderEventMap[K]) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface HTMLFrameElement extends HTMLElement, GetSVGDocument {
  ...
  /**
      ...
      */
  width: string | number;
  addEventListener<K extends keyof HTMLFrameElementEventMap>(
    type: K,
...
interface HTMLIFrameElement extends HTMLElement, GetSVGDocument {
  ...
  addEventListener<K extends keyof HTMLIFrameElementEventMap>(
    ...
    listener: (
      ...
      ev: HTMLIFrameElementEventMap[K]
    ) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
...
interface MSAppAsyncOperation extends EventTarget {
  ...
  addEventListener<K extends keyof MSAppAsyncOperationEventMap>(
    type: K,
    listener: (
      this: MSAppAsyncOperation,
      ev: MSAppAsyncOperationEventMap[K]
    ) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
...
interface MSCredentials {
  getAssertion(
    challenge: string,
    filter?: MSCredentialFilter,
    params?: MSSignatureParameters
  ): Promise<MSAssertion>;
  makeCredential(
    accountInfo: MSAccountInfo,
    params: MSCredentialParameters[],
    challenge?: string
  ): Promise<MSAssertion>;
}
...
interface MSHTMLWebViewElement extends HTMLElement {
  ...
  addEventListener<K extends keyof HTMLElementEventMap>(
    type: K,
    listener: (this: MSHTMLWebViewElement, ev: HTMLElementEventMap[K]) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface MSStreamReader extends EventTarget, MSBaseReader {
  ...
  addEventListener<K extends keyof MSBaseReaderEventMap>(
    type: K,
    listener: (this: MSStreamReader, ev: MSBaseReaderEventMap[K]) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface MSWebViewAsyncOperation extends EventTarget {
  ...
  addEventListener<K extends keyof MSWebViewAsyncOperationEventMap>(
    type: K,
    listener: (
      this: MSWebViewAsyncOperation,
      ev: MSWebViewAsyncOperationEventMap[K]
    ) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
...
interface OscillatorNode extends AudioNode {
  ...
  stop(when?: number): void;
  addEventListener<K extends keyof OscillatorNodeEventMap>(
    type: K,
...
interface RTCDtlsTransport extends RTCStatsProvider {
  ondtlsstatechange:
    | ((this: RTCDtlsTransport, ev: RTCDtlsTransportStateChangedEvent) => any)
    | null;
...
interface RTCIceTransport extends RTCStatsProvider {
  ...
  oncandidatepairchange:
    | ((this: RTCIceTransport, ev: RTCIceCandidatePairChangedEvent) => any)
    | null;
  onicestatechange:
    | ((this: RTCIceTransport, ev: RTCIceTransportStateChangedEvent) => any)
    | null;
  readonly role: RTCIceRole;
  readonly state: RTCIceTransportState;
  addRemoteCandidate(
    remoteCandidate: RTCIceCandidateDictionary | RTCIceCandidateComplete
  ): void;
...
interface RTCRtpReceiver extends RTCStatsProvider {
  ...
  stop(): void;
  addEventListener<K extends keyof RTCRtpReceiverEventMap>(
    type: K,
...
interface RTCRtpSender extends RTCStatsProvider {
  ...
  onssrcconflict:
    | ((this: RTCRtpSender, ev: RTCSsrcConflictEvent) => any)
    | null;
  readonly rtcpTransport: RTCDtlsTransport;
  readonly track: MediaStreamTrack;
  readonly transport: RTCDtlsTransport | RTCSrtpSdesTransport;
  ...
  stop(): void;
  addEventListener<K extends keyof RTCRtpSenderEventMap>(
    type: K,
    listener: (this: RTCRtpSender, ev: RTCRtpSenderEventMap[K]) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface DocumentEvent {
  ...
  createEvent(
    eventInterface: "LongRunningScriptDetectedEvent"
  ...
  createEvent(
    eventInterface: "NavigationCompletedEvent"
  ): NavigationCompletedEvent;
  createEvent(eventInterface: "NavigationEvent"): NavigationEvent;
  createEvent(
    eventInterface: "NavigationEventWithReferrer"
  ...
  createEvent(
    eventInterface: "UnviewableContentIdentifiedEvent"
...
interface MSBaseReader {
  ...
  addEventListener<K extends keyof MSBaseReaderEventMap>(
    type: K,
    listener: (this: MSBaseReader, ev: MSBaseReaderEventMap[K]) => any,
    useCapture?: boolean
  ): void;
  addEventListener(
    type: string,
...
interface NodeSelector {
  ...
  querySelectorAll<K extends keyof ElementListTagNameMap>(
    selectors: K
  ): ElementListTagNameMap[K];
